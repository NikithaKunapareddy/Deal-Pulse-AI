...
import { predict, User } from '@/lib/api'
...
export default function PredictionForm({ onPredictionComplete, currentUser }: PredictionFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!currentUser) {
      setError('Please select an active user profile first')
      return
    }
